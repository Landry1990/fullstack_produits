...
export const useProductSearch = (
            ...
            if (qtyStr !== undefined) {
                ...
                if (exists) {
                    ...
                    linesToAdd.push({
                        ...
                        produit_cip: selectedProductForLot.cip1 || selectedProductForLot.cip2 || selectedProductForLot.cip3 || selectedProductForLot.cip4 || undefined,
    ...
    const handleAddProduct = async (
        ...
        const temporaryLine: LigneInventaire = {
            ...
            produit_cip: product.cip1 || product.cip2 || product.cip3 || product.cip4 || undefined,
