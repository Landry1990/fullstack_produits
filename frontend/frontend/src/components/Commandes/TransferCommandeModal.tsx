                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {hasPriceInfo && (
                                                <>
                                                    ...
                                                    {priceDiff !== 0 && (
                                                        <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-caption font-bold ${priceDiff > 0 ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'}`}>
                                            ...
                                            {!hasPriceInfo && transferTargetFournisseur && !loadingCatalogue && (
                                                <span className="inline-flex items-center px-1.5 py-0.5 rounded text-caption font-bold bg-slate-100 text-slate-600">{t('orders:transfer_modal.unknown_price')}</span>
                                            )}
                                        </div>
                                    </div>
                                );
