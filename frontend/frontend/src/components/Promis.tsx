...
const Promis: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6 space-y-6 font-sans">
                ...
                <div className="w-full space-y-4">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 flex flex-col">
                        <div className="p-6 border-b border-gray-100">
                            <h1 className="text-3xl font-black text-gray-900 tracking-tight">{t('stock:promis.title', 'Promised Products Management')}</h1>
                            <p className="text-gray-500 font-medium text-sm mt-1">{t('stock:promis.subtitle', 'Manage promised products, deliveries and stock returns')}</p>
                        </div>
            ...
            {/* Main Content: Table */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden flex flex-col h-[calc(100vh-28rem)] min-h-[400px]">
                <PromisTable 
