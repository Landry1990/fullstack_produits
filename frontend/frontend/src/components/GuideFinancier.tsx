...
const GuideFinancier: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      {/* Hero Header */}
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-8 text-white shadow-xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 space-y-4">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm sticky top-24 p-4">
            <h3 className="font-bold text-xs uppercase tracking-widest text-slate-400 mb-4">{t('guide.summary')}</h3>
            <nav className="space-y-1">
              <a href="#vendeurs" className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-100 transition-colors group">
                <div className="flex items-center gap-3">
                  <Users className="size-4 text-blue-500" />
                  <span className="text-sm font-bold text-slate-700">{t('guide.sections.seller_ranking.title')}</span>
                </div>
                <ArrowRight className="size-3 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0 text-slate-400" />
              </a>
              <a href="#fournisseurs" className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-100 transition-colors group">
                <div className="flex items-center gap-3">
                  <Package className="size-4 text-indigo-500" />
                  <span className="text-sm font-bold text-slate-700">{t('guide.sections.supplier_purchases.title')}</span>
                </div>
                <ArrowRight className="size-3 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0 text-slate-400" />
              </a>
              <a href="#scoring" className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-100 transition-colors group">
                <div className="flex items-center gap-3">
                  <ShieldCheck className="size-4 text-emerald-500" />
                  <span className="text-sm font-bold text-slate-700">{t('guide.sections.scoring_performance.title')}</span>
                </div>
                <ArrowRight className="size-3 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0 text-slate-400" />
              </a>
              <a href="#opportunites" className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-100 transition-colors group">
                <div className="flex items-center gap-3">
                  <Lightbulb className="size-4 text-amber-500" />
                  <span className="text-sm font-bold text-slate-700">{t('guide.sections.advanced_analysis.title')}</span>
                </div>
                <ArrowRight className="size-3 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0 text-slate-400" />
              </a>
            </nav>
        ...
        <div className="md:col-span-2 space-y-12">
          ...
          <section id="vendeurs" className="scroll-mt-24">
            ...
            <div className="prose prose-sm max-w-none text-slate-600 leading-relaxed">
              ...
              <div className="bg-slate-50 rounded-2xl p-6 my-6 border border-slate-200">
                <h4 className="flex items-center gap-2 text-blue-600 font-bold mb-3 uppercase tracking-tighter text-xs">
          ...
          <section id="fournisseurs" className="scroll-mt-24">
            ...
            <div className="prose prose-sm max-w-none text-slate-600">
              ...
              <div className="bg-slate-50 rounded-2xl p-6 my-6 border border-slate-200">
                <h4 className="flex items-center gap-2 text-indigo-600 font-bold mb-3 uppercase tracking-tighter text-xs">
                ...
                <h4 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-2">{t('guide.sections.supplier_purchases.calculation')}</h4>
                <div className="mb-4 font-mono p-4 bg-slate-100 rounded-xl text-center font-bold text-sm text-slate-700">
          ...
          <section id="scoring" className="scroll-mt-24">
            ...
            <div className="space-y-6">
              ...
              <h4 className="text-xs font-bold uppercase tracking-widest text-slate-400">{t('guide.sections.scoring_performance.criteria')}</h4>
              <div className="grid grid-cols-1 gap-4">
                <div className="flex gap-4 p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                  <div className="font-black text-2xl text-slate-200">30%</div>
                  <div>
                    <h4 className="font-bold text-slate-700">{t('guide.sections.scoring_performance.volume')}</h4>
                    <p className="text-xs text-slate-500">{t('guide.sections.scoring_performance.volume_desc')}</p>
                  </div>
                </div>
                <div className="flex gap-4 p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                  <div className="font-black text-2xl text-slate-200">30%</div>
                  <div>
                    <h4 className="font-bold text-slate-700">{t('guide.sections.scoring_performance.quality')}</h4>
                    <p className="text-xs text-slate-500">{t('guide.sections.scoring_performance.quality_desc')}</p>
                  </div>
                </div>
                <div className="flex gap-4 p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
                  <div className="font-black text-2xl text-slate-200">40%</div>
                  <div>
                    <h4 className="font-bold text-slate-700">{t('guide.sections.scoring_performance.regularity')}</h4>
                    <p className="text-xs text-slate-500">{t('guide.sections.scoring_performance.regularity_desc')}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="prose prose-sm max-w-none text-slate-600">
              ...
              <div className="grid grid-cols-1 gap-4 mt-6">
                <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-2xl p-4 shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-amber-800">{t('guide.sections.advanced_analysis.low_margin')}</h4>
                    <p className="text-xs text-amber-700">{t('guide.sections.advanced_analysis.low_margin_desc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-700">{t('guide.sections.advanced_analysis.price_optimization')}</h4>
                    <p className="text-xs text-slate-500">{t('guide.sections.advanced_analysis.price_optimization_desc')}</p>
                  </div>
                </div>
              </div>
