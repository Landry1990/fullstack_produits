...
const mockProps = {
    ...
    fileInputRef: { current: null } as unknown,
    setIsCreateProduitModalOpen: vi.fn(),
    searchInputRef: { current: null } as unknown,
    fournisseurSelectRef: { current: null } as unknown,
    searchProduitQuery: '',
