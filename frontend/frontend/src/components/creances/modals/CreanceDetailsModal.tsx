            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 p-4 bg-base-200/50 rounded-2xl border border-base-200 shadow-inner">
                    <div className="flex-1 space-y-1">
                        ...
                        <div className="text-sm font-bold text-base-content/60">{t('creances:details_modal.issued_on')} {new Date(creance.date).toLocaleDateString('fr-FR')}</div>
                    </div>
                    <div className="flex-1 space-y-1 md:border-l md:pl-4 border-base-300">
                        ...
                        <div className="text-xs font-semibold text-base-content/50">{creance.ayant_droit_details?.nom || t('creances:details_modal.no_beneficiary')}</div>
                    </div>
                    <div className="flex-1 space-y-1 md:border-l md:pl-4 border-base-300">
                            ...
                            <table className="table w-full">
                                <thead>
                                    <tr className="bg-base-100 border-b border-base-200">
                                        <th className="text-[9px] font-black uppercase text-base-content/40 tracking-widest">{t('creances:details_modal.headers.date')}</th>
                                        <th className="text-[9px] font-black uppercase text-base-content/40 tracking-widest">{t('creances:details_modal.headers.mode')}</th>
                                        <th className="text-[9px] font-black uppercase text-base-content/40 tracking-widest">{t('creances:details_modal.headers.reference')}</th>
                                        <th className="text-[9px] font-black uppercase text-base-content/40 tracking-widest text-right">{t('creances:details_modal.headers.amount')}</th>
                                        <th className="text-[9px] font-black uppercase text-base-content/40 tracking-widest text-center">{t('creances:details_modal.headers.actions')}</th>
                                    </tr>
                                </thead>
