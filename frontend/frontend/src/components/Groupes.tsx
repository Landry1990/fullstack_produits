      ...
      {isModalOpen && (
        <div className="modal modal-open">
          <div className="modal-box">
            <h3 className="font-bold text-lg mb-4">{editingGroupe ? 'Modifier le groupe' : 'Nouveau groupe'}</h3>
            <form onSubmit={handleSubmitGroupe}>
              <div className="form-control w-full mb-4">
                <label className="label"><span className="label-text">Nom du groupe</span></label>
                <input 
                  type="text" 
      ...
      {isAddProductModalOpen && (
         <div className="modal modal-open">
           <div className="modal-box w-11/12 max-w-3xl h-[600px] flex flex-col">
              <h3 className="font-bold text-lg mb-2">Ajouter des produits à "{selectedGroupe?.nom}"</h3>
              <p className="text-sm opacity-60 mb-4">Recherchez des produits et cliquez sur le <b>+</b> pour les associer à ce groupe.</p>
