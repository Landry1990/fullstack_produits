...
export const ProductDetailsModal: React.FC<ProductDetailsModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-4">
            <div className="bg-white rounded-xl shadow-2xl border border-gray-100 w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
                {/* Header */}
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-gray-500">
                            ...
                            <span className="flex items-center gap-1.5 shrink-0" title={t('table.operator')}>
                                ...
                                <span className="text-gray-400 text-xs">{t('table.operator')} :</span>
                            ...
                            {facture.paiements && facture.paiements.length > 0 && facture.paiements[0].user_details ? (
                                <>
                                    ...
                                    <span className="flex items-center gap-1.5 shrink-0" title="Caissier">
                                        ...
                                        <span className="text-gray-400 text-xs">Caissier :</span>
                            ...
                            <div className="mt-2 flex items-center gap-2 text-xs text-gray-500">
                                ...
                                <div className="flex gap-2">
                                    {facture.paiements.map((p, idx) => (
                                        <span key={idx} className="bg-gray-50 px-1.5 py-0.5 rounded text-gray-700 border border-gray-200 text-[10px]">
                                ...
                                {facture.produits.map((prod) => {
                                    ...
                                    return (
                                        <tr key={prod.id} className="hover:bg-gray-50/50 transition-colors group">
                                            ...
                                            <td className="px-6 py-3 text-right font-medium font-mono text-gray-700 group-hover:text-indigo-600 transition-colors">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-all ${
                                                            sendingReminder === prod.id
                                                                ...
                                                                : 'border border-emerald-200 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 hover:shadow-sm'
                                                        }`}
                ...
                <div className="bg-gray-50 border-t border-gray-100 p-6">
                    ...
                    <div className="flex flex-wrap items-center justify-end gap-8 text-sm">
                        <div className="flex flex-col items-end border-r border-gray-200 pr-8 last:border-0 last:pr-0">
                            <span className="text-[10px] uppercase font-black tracking-widest text-gray-400 mb-1">{t('fields.subtotal_ht')}</span>
                            <span className="font-mono font-bold text-gray-700">{formatCurrency(totals.totalHt)}</span>
                        </div>
                        <div className="flex flex-col items-end border-r border-gray-200 pr-8 last:border-0 last:pr-0">
                            <span className="text-[10px] uppercase font-black tracking-widest text-gray-400 mb-1">{t('fields.vat')}</span>
                            <span className="font-mono font-bold text-gray-700">{formatCurrency(totals.totalTva)}</span>
                        </div>
                        {totals.remise > 0 && (
                            <div className="flex flex-col items-end border-r border-gray-200 pr-8 last:border-0 last:pr-0">
