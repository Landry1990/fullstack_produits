...
export default function FinanceFournisseurModal({ isOpen, onClose, fournisseur, onSuccess }: FinanceFournisseurModalProps) {
    ...
    return (
        <dialog className="modal modal-open">
            <div className="modal-box w-11/12 max-w-4xl h-[80vh] flex flex-col p-0 overflow-hidden">
                {/* Header */}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="form-control">
                                ...
                                <div className="relative">
                                    <input 
                                        type="number" 
                                        className="input input-bordered w-full pl-9 font-mono font-bold text-lg" 
                                        placeholder="0"
                                        value={montant}
                                        ...
                                        min="0"
                                    />
                                    <span className="absolute left-3 top-3 text-slate-400 font-bold">F</span>
                                </div>
                            </div>
