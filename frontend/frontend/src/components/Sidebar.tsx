...
export default function Sidebar() {
  const menuItems = [
    ...
    { path: '/facturation', label: 'Facturation', icon: (
    ...
    <aside className="w-64 bg-base-100 border-r border-base-300 flex flex-col h-screen sticky top-0">
      ...
      <div className="p-4 border-t border-base-300">
        <div className="flex items-center gap-3 p-2 rounded-lg bg-base-200/50">
          <div className="w-8 h-8 rounded-full bg-neutral text-neutral-content flex items-center justify-center text-sm">
            A
          </div>
