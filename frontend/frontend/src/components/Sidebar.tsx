...
export default function Sidebar() {
  ...
  const allMenuItems = useMemo(() => [
    ...
    { path: '/app/rapport-equipes', label: t('teams_report_sidebar', 'Rapport Équipes'), key: 'manager_sidebar', category: 'accueil', icon: (
    ...
    )},
    {
      ...
      submenus: [
        ...
        { path: '/app/avoirs-clients', label: t('ventes.avoirs_clients'), key: 'ventes_avoirs_clients' },
    ...
    // user_sessions est regroupé dans l'onglet Sessions de /app/utilisateurs
    {
