...
export default function FournisseurDetails({ hook }: Props) {
  ...
  return (
    <div className="md:col-span-2 bg-base-100 rounded-lg shadow flex flex-col h-full overflow-hidden animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="p-6 border-b bg-base-200/50 shrink-0 flex justify-between items-start sticky-header">
         <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="badge badge-info badge-xs font-bold uppercase tracking-wider">{t('providers:table.provider')}</span>
            </div>
          ...
          <div className="space-y-6">
              <div className="flex gap-4 group">
                  ...
                  <div className="flex-1">
                      ...
                      <div className="text-base-content/90 font-medium whitespace-pre-wrap leading-relaxed bg-base-200/30 p-3 rounded-xl border border-base-200 hover:border-primary/30 transition-colors">
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="flex gap-4 group">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="text-base-content/80 font-semibold break-all selection:bg-primary/20 underline decoration-primary/30 decoration-2 underline-offset-4">{selectedFournisseur.email || '-'}</div>
                    </div>
                </div>
              </div>
          </div>
          ...
          <div className="pt-6 mt-4 border-t border-base-200">
            ...
            <div className="grid grid-cols-2 gap-4">
               <div className="p-4 rounded-xl bg-base-200/50 border border-base-200">
                  ...
                  <div className={`text-2xl font-black font-mono ${solde > 0 ? 'text-error' : 'text-success'}`}>
                     {formatCurrency(solde)}
                  </div>
               </div>
               <div className="p-4 rounded-xl bg-base-200/50 border border-base-200 flex items-center justify-center text-base-content/40 text-xs italic text-center">
                    ...
                    <table className="table table-xs w-full">
                      ...
                      <tbody>
                        {filteredCatalogue.map((item) => (
                          <tr key={item.produit_id} className="hover:bg-base-200/50 border-b border-base-200 last:border-0">
                            <td className="py-2">
