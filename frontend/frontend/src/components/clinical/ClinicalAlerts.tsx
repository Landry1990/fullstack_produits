  ...
  return (
    <div className="flex flex-col gap-2 mt-4 px-4">
      ...
      {severeAlerts.map((alert) => (
        <div key={`severe-${alert.title}`} role="alert" className="flex items-start gap-3 p-4 rounded-lg bg-error-soft text-error-strong dark:bg-red-900/20 dark:text-red-400 border border-red-200 dark:border-red-800 shadow-lg">
      ...
      {moderateAlerts.map((alert) => (
        <div key={`mod-${alert.title}`} role="alert" className="flex items-start gap-3 p-4 rounded-lg bg-warning-soft text-warning-strong dark:bg-amber-900/20 dark:text-amber-400 border border-amber-200 dark:border-amber-800 shadow-md">
