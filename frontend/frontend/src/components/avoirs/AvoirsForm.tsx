                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">
                            {viewMode === 'EDIT' ? `Modifier l'Avoir #${editingAvoirId}` : 'Nouvel Avoir'}
                        </h1>
                        <p className="text-sm text-base-content/60">
                            Sauvegardez l'avoir en brouillon avant de le valider.
                        </p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-base-100 rounded-2xl shadow-sm border border-base-300 p-5 space-y-4">
                        <h2 className="font-bold text-lg border-b border-base-200 pb-2">Informations Générales</h2>
                        ...
                        <div className="form-control">
                            <label className="label font-medium text-sm text-base-content/70">
                                Motif / Type <span className="text-error">*</span>
                            </label>
                            <select 
                        ...
                        <div className="flex-1 p-0 overflow-x-auto">
                            {lignes.length === 0 ? (
                                <div className="flex flex-col items-center justify-center h-64 text-base-content/40 gap-4">
                                    ...
                                    <p className="text-lg font-medium">Recherchez un produit pour commencer</p>
                                </div>
                            ) : (
                                <table className="table w-full">
                                    <thead className="bg-base-200/50 sticky top-0 z-[5]">
                                        <tr>
                                            <th>Produit</th>
                                            <th className="w-32">Lot & Exp</th>
                                            <th className="w-24 text-center">Qté</th>
                                            <th className="w-32 text-right">Prix Unitaire</th>
                                                    ...
                                                    <td>
                                                        <div className="flex flex-col gap-1">
                                                            ...
                                                            <div className="text-xs opacity-60">
                                                                {ligne.date_expiration ? ligne.date_expiration : 'Aucune date'}
                                                            </div>
                                                            <button
                                                                type="button"
                            ...
                            <div className="p-4 sm:p-6 bg-base-200/30 border-t border-base-200 rounded-b-2xl">
                                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                                    <div className="text-sm font-medium text-base-content/60">
                                        {lignes.length} article(s) • {lignes.reduce((sum, l) => sum + Number(l.quantity), 0)} unité(s)
                                    </div>
                                    <div className="flex items-center gap-4 bg-base-100 px-6 py-3 rounded-xl shadow-sm border border-base-200">
                                        <span className="text-base-content/70 font-bold uppercase tracking-wider text-sm">Montant Total :</span>
