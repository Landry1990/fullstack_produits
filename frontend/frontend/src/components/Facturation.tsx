        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1 border-l border-base-200 pl-2 ml-1">
            <button
              ...
              className={`w-7 h-7 rounded-lg flex items-center justify-center transition-all ${hook.isZenithMode ? 'bg-primary text-white' : 'text-base-content/40 hover:text-base-content hover:bg-base-200'}`}
            ...
            <button
              ...
              className={`w-7 h-7 rounded-lg flex items-center justify-center transition-all ${hook.isMidnightTheme ? 'bg-secondary text-white' : 'text-base-content/40 hover:text-base-content hover:bg-base-200'}`}
