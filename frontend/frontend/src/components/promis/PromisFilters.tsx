                ...
                <div className="flex flex-1 gap-4 items-center w-full md:w-auto">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-gray-200 bg-gray-50 pl-9 text-sm font-medium text-gray-900 focus:outline-none focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all"
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            className="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm font-medium text-gray-900 focus:outline-none focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all min-w-[140px]"
                            value={filterStatus}
