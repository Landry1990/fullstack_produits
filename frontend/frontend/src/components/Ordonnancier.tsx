                ...
                <div className="overflow-x-auto h-full">
                    <table className="min-w-full table-fixed divide-y divide-slate-200">
                        <thead className="bg-slate-100 sticky top-0 z-10">
                            <tr>
                                <th className="px-3 py-2 whitespace-nowrap text-left text-xs font-semibold uppercase tracking-wide text-slate-500 w-20">{t('table.order_num')}</th>
                                <th className="px-3 py-2 whitespace-nowrap text-left text-xs font-semibold uppercase tracking-wide text-slate-500 w-28">{t('table.date')}</th>
                                <th className="px-3 py-2 whitespace-nowrap text-left text-xs font-semibold uppercase tracking-wide text-slate-500 w-[25%]">{t('table.patient')}</th>
                                <th className="px-3 py-2 whitespace-nowrap text-left text-xs font-semibold uppercase tracking-wide text-slate-500 w-[25%]">{t('table.prescriber')}</th>
                                <th className="px-3 py-2 whitespace-nowrap text-left text-xs font-semibold uppercase tracking-wide text-slate-500">{t('table.meds')}</th>
                                <th className="px-3 py-2 whitespace-nowrap text-center text-xs font-semibold uppercase tracking-wide text-slate-500 w-20">{t('table.action')}</th>
                            </tr>
                        </thead>
                            ...
                            {loading ? (
                                ...
                                ordonnancier.map((entry) => (
                                    <tr key={entry.numero_ordre} className="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td className="px-3 py-2 whitespace-nowrap text-sm font-medium text-slate-700">{entry.patient_nom}</td>
                                        <td className="px-3 py-2 whitespace-nowrap text-sm text-slate-600">{entry.prescripteur_nom}</td>
                                        <td className="px-3 py-2 whitespace-nowrap">
