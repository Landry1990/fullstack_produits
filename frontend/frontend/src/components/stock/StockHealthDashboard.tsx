            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                >
                    ...
                    <div className="absolute top-6 right-6 flex gap-2">
                         <button 
                            ...
                            className="inline-flex items-center justify-center rounded-full size-8 bg-primary/10/50 text-base-content/50 hover:text-primary hover:bg-info/10 transition-all opacity-0 group-hover:opacity-100"
                        >
                    ...
                    <div className="relative">
                        <div className={`size-36 rounded-full border-8 border-base-300 flex items-center justify-center mb-6 transition-all duration-1000 group-hover:scale-105 shadow-[0_0_40px_rgba(0,0,0,0.02)]`}>
                                ...
                                <div className="card-body">
                                    ...
                                    <ul className="text-xs space-y-2">
                                        <li className="flex items-start gap-2">
                                            <span className="text-error font-bold w-12 shrink-0">&ge; 80%</span> 
                                            <span className="text-base-content"><strong>Sain</strong> : Stock optimal, peu de ruptures, rotation fluide.</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="text-amber-500 font-bold w-12 shrink-0">50-79%</span> 
                                            <span className="text-base-content"><strong>Moyen</strong> : Attention à l'accumulation de stock dormant ou aux ruptures à venir.</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="text-rose-500 font-bold w-12 shrink-0">&lt; 50%</span> 
                                            <span className="text-base-content"><strong>Critique</strong> : Fort dysfonctionnement. Trop de liquidités immobilisées ou trop de ventes manquées.</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <p className="relative text-sm text-base-content/50 font-medium mt-1">
                ...
                <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <div className="size-14 bg-error/10 rounded-2xl flex items-center justify-center text-error mb-6 font-bold shadow-inner">
                            <AlertCircle className="size-7" />
                        </div>
                        <div className="flex items-center gap-2 mb-1">
                            <div className="text-xs font-black uppercase tracking-[0.2em] text-error/50">
                        ...
                        <div className="text-3xl font-black text-error tracking-tighter mb-2">
                           -<AnimatedNumber 
                        ...
                        <div className="flex items-center gap-2 mb-6">
                            <div className="flex items-center gap-2 text-sm font-bold text-error/60 bg-error/10 w-fit px-3 py-1 rounded-full">
                        ...
                        <button 
                            ...
                            className="inline-flex items-center justify-center px-3 py-1.5 text-sm bg-error text-white hover:bg-error-focus text-white rounded-xl gap-2 shadow-lg shadow-red-500/20 hover:scale-105 active:scale-95 transition-all w-full md:w-auto h-11"
                        >
                            <ShoppingCart className="size-4" />
                            {t('stock:analyse.dashboard.fix_ruptures_btn')}
                        </button>
                        
                        <p className="mt-4 text-xs text-base-content/50 font-medium leading-relaxed italic">
                ...
                >
                    ...
                    <div>
                        <div className="flex items-center gap-1.5">
                            <div className="text-[10px] font-black uppercase text-base-content/50 tracking-widest">
