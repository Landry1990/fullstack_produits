    ...
    return (
        <div className="bg-base-100 rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                {reports.map((report) => (
                    <div key={report.id} className="p-6 rounded-xl bg-gray-50 border border-gray-200 hover:bg-base-100 hover:border-primary/20 transition-all flex flex-col h-full group">
