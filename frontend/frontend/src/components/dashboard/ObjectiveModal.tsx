...
export const ObjectiveModal: React.FC<ObjectiveModalProps> = ({
    ...
    return (
        <div className="modal modal-open">
            <div className="modal-box rounded-xl border border-base-300 shadow-sm p-0 overflow-hidden max-w-lg">
                ...
                <div className="p-6 space-y-4 bg-base-100">
                    <div className="form-control w-full">
                        ...
                        <select 
                            className="select select-bordered rounded-xl font-bold bg-base-200"
                    ...
                    <div className="form-control w-full">
                        ...
                        <input 
                            ...
                            className="input input-bordered rounded-xl font-black text-2xl bg-base-200 h-16"
                    ...
                    <div className="form-control w-full">
                        ...
                        <input 
                            type="date" 
                            className="input input-bordered rounded-xl font-bold bg-base-200 h-12"
