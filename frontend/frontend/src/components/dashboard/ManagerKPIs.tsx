    ...
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {items.map((item) => {
                ...
                return (
                    <div key={item.key} className={`bg-base-100 rounded-xl shadow-sm border ${isSuccess ? 'border-emerald-200 shadow-emerald-100 shadow-lg relative overflow-visible' : 'border-base-300 overflow-hidden'} transition-all duration-500`}>
                        {isSuccess && (
                        ...
                        <div className="p-6 h-full flex flex-col justify-between relative overflow-hidden">
                            ...
                            <div className="flex justify-between items-center mb-4 relative z-10">
                                ...
                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold transition-colors duration-500 ${isSuccess ? 'bg-success/20 text-success animate-pulse shadow-sm' : item.key === 'jour' ? 'bg-primary/20 text-primary' : item.key === 'semaine' ? 'bg-info/20 text-info' : 'bg-warning/20 text-warning'}`}>
                            ...
                            <div className="mb-4 relative z-10">
                                ...
                                {data.margin !== undefined && (
                                    <div className="text-xs font-bold text-base-content/60 mt-1 flex items-center gap-1">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between text-xs font-bold uppercase tracking-tight text-base-content/50">
