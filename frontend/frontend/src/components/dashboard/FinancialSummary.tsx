...
export default function FinancialSummary({
  ...
  return (
    <div className="space-y-6">
      {/* Section Unités Gratuites (UG) - Hide for VENDEUR/CAISSIER if role exists */}
      {ugStats && ugStats.results && stats?.role !== 'VENDEUR' && stats?.role !== 'CAISSIER' && (
        <div className="card bg-base-100 shadow-sm border border-base-300 rounded-2xl overflow-hidden max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 auto-rows-fr">
        ...
        <div className="card bg-base-100 shadow-sm border border-base-300 rounded-2xl overflow-hidden h-full flex flex-col">
          <div className="card-body p-6 flex flex-col h-full">
            ...
            <div className="flex-grow overflow-y-auto min-h-[300px] max-h-[400px] custom-scrollbar pr-1">
