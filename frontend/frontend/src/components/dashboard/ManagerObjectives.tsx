...
export const ManagerObjectives: React.FC<ManagerObjectivesProps> = ({ currentObj, onEdit, onRefresh }) => {
    ...
    const objectiveTypes = [
        ...
        { label: t('manager_dashboard.periods.monthly', 'Mensuel'), code: 'MOIS', color: 'text-warning' }
    ];
        ...
        <div className="bg-base-100 rounded-xl shadow-sm border border-base-300 overflow-hidden flex flex-col">
            ...
            <div className="p-6 space-y-3">
                {objectiveTypes.map(p => {
                    ...
                    return (
                        <div key={p.code} className="flex items-center justify-between p-4 rounded-xl border border-base-200 hover:bg-base-200 transition-all group">
                            <div>
                                ...
                                {obj && obj.date_debut && (
                                    <div className="text-[10px] text-base-content/50 font-bold uppercase mt-0.5">
