    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-4xl p-0 overflow-hidden rounded-3xl border border-base-200 shadow-2xl bg-base-100 flex flex-col h-[90vh]">
        ...
        <form onSubmit={onSubmit} className="flex-1 overflow-y-auto p-8 space-y-8">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="form-control">
                      <label className="label py-1"><span className="label-text text-[10px] uppercase font-black tracking-widest text-base-content/40">{t('clients.finance.auto_discount')} (%)</span></label>
                      <input 
                        type="number" 
                        className="input input-bordered input-md rounded-xl font-bold" 
                    ...
                    {data.client_type === 'PROFESSIONNEL' && (
                        <>
                            ...
                            <div className="form-control">
                              <label className="label py-1"><span className="label-text text-[10px] uppercase font-black tracking-widest text-base-content/40">{t('clients.finance.coverage')} (%)</span></label>
                              <input 
                                type="number" 
               ...
               <div className="space-y-6 pt-4 animate-in fade-in slide-in-from-top-4 duration-300">
                  ...
                  <div className="bg-base-200/50 p-6 rounded-3xl border border-base-300/30 space-y-4">
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 items-end">
                        ...
                        <div className="lg:col-span-2">
                           <label className="label pt-0"><span className="label-text text-[10px] uppercase font-black tracking-widest text-base-content/40">Matricule</span></label>
                           <input 
                           ...
                           <table className="table table-xs w-full">
                              <thead className="bg-base-200/50">
                                 <tr>
                                    ...
                                    <th className="py-3 px-4 text-[9px] uppercase font-black tracking-widest text-right">Matricule</th>
        ...
        <div className="p-6 border-t border-base-200 bg-base-100 flex justify-end gap-3 shrink-0">
          ...
          <button 
            type="submit" 
            form="modal-form" // Wait, I need a form ID
