...
export default function Perimes() {
  ...
  const getUrgencyClass = (valeur: number) => {
    if (valeur > 500000) return 'border-red-500 bg-error/10'
    if (valeur > 100000) return 'border-amber-500 bg-warning/10'
    return 'border-emerald-500 bg-success/10'
  }

  return (
    <div className="h-full flex flex-col bg-base-100 overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-base-200 bg-base-100 sticky top-0 z-30  shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] font-medium text-base-content/50 uppercase tracking-widest">{t('perimes.subtitle')}</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="inline-flex items-center gap-1 bg-base-200 p-1 border border-base-300 rounded-xl">
            <button 
              className={`inline-flex items-center gap-2 h-8 px-3 rounded-lg text-xs font-medium transition-all duration-200 ${activeTab === 'dashboard' ? 'bg-primary text-white shadow-sm' : 'hover:bg-base-300'}`}
            ...
            <button 
              className={`inline-flex items-center gap-2 h-8 px-3 rounded-lg text-xs font-medium transition-all duration-200 ${activeTab === 'list' ? 'bg-primary text-white shadow-sm' : 'hover:bg-base-300'}`}
            ...
            <button 
              className={`inline-flex items-center gap-2 h-8 px-3 rounded-lg text-xs font-medium transition-all duration-200 ${activeTab === 'history' ? 'bg-primary text-white shadow-sm' : 'hover:bg-base-300'}`}
          ...
          <button 
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 rounded-lg text-sm font-medium transition-colors gap-2 h-9 px-3 rounded-lg hover:bg-base-300" 
      ...
      {error && (
        <div className="px-6 pt-4 shrink-0">
          <div role="alert" className="p-3 rounded-lg bg-error/10 border border-red-200 text-red-800 flex items-start gap-2">
      ...
      <div className="flex-1 overflow-auto px-6 py-4">
        {activeTab === 'dashboard' ? (
          ...
          <div className="space-y-6">
            ...
            {loadingStats ? (
              ...
              <>
                    ...
                    <div className="p-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-base-content/60">{t('perimes.stats.lots_count', { count: stats.perimes.count_lots })}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="p-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-base-content/60">{t('perimes.stats.at_sale_price')}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="p-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-base-content/60">{t('perimes.stats.vs_ca')} ({formatCurrency(stats.indicateurs.ca_periode)})</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {/* Prévisions Section */}
                <div className="bg-base-100 border border-base-200 shadow-sm rounded-xl p-5">
                  <div className="p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className={`border-2 rounded-xl p-4 ${getUrgencyClass(stats.previsions['30j'].valeur_vente)}`}>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-base-200 text-base-content border border-base-300">{t('perimes.prevision.lots_count', { count: stats.previsions['30j'].count_lots })}</span>
                        </div>
                      ...
                      <div className={`border-2 rounded-xl p-4 ${getUrgencyClass(stats.previsions['60j'].valeur_vente)}`}>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-base-200 text-base-content border border-base-300">{t('perimes.prevision.lots_count', { count: stats.previsions['60j'].count_lots })}</span>
                        </div>
                      ...
                      <div className={`border-2 rounded-xl p-4 ${getUrgencyClass(stats.previsions['90j'].valeur_vente)}`}>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-base-200 text-base-content border border-base-300">{t('perimes.prevision.lots_count', { count: stats.previsions['90j'].count_lots })}</span>
                        </div>
                    ...
                    <div className="p-5">
                          ...
                          <tbody>
                            {stats.perimes.details.slice(0, 10).map((item) => (
                              <tr key={item.lot_id} className="hover">
                                ...
                                <td>
                                  <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-error/10 text-error border border-red-200">
                      ...
                      {stats.perimes.details.length > 10 && (
                        <div className="mt-3 text-center">
                          <button 
                            className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 rounded-lg text-sm font-medium transition-colors"
                            onClick={() => setActiveTab('list')}
                          >
                     ...
                     {selectedLotIds.size > 0 ? (
                        <div className="flex items-center gap-2 ">
                          <div className="relative inline-block">
                            <div tabIndex={0} role="button" className="inline-flex items-center justify-center gap-2 h-9 px-3 bg-primary text-white rounded-lg text-xs font-bold hover:bg-primary-focus transition-colors shadow-sm">
                              <MoreVertical className="size-4" />
                              {t('common:actions_title')}
                              <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-base-200 text-base-content border border-base-300 bg-primary-focus border-none text-white">{selectedLotIds.size}</span>
                            </div>
                            <ul tabIndex={0} className="absolute z-50 mt-1 bg-base-100 rounded-lg shadow-lg border border-base-300 min-w-[14rem] py-1 z-[100] flex flex-col gap-0.5 p-2 shadow-lg bg-base-100 rounded-lg w-56 border border-base-200 mt-2">
                              <li className="px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-base-content/50">
                          ...
                          <button 
                            ...
                            className="inline-flex items-center gap-2 h-9 px-3 text-base-content/60 hover:text-base-content hover:bg-base-200 rounded-lg text-xs font-medium transition-colors"
                          >
                            <X className="size-4" />
                            {t('common:cancel')}
                          </button>
                        ...
                        <>
                           ...
                           <div className="flex gap-3 items-center">
                              <div className="flex items-center gap-2 bg-base-200 p-1 px-3 rounded-xl border border-base-300">
                                <span className="text-[10px] font-bold text-base-content/50 uppercase">{t('common:filters')}</span>
                                <div className="h-4 w-[1px] bg-base-300 mx-1"></div>
                                <label className="flex items-center gap-2 cursor-pointer group">
                                  <input 
                                      type="checkbox" 
                                      className="size-3.5 rounded border-base-300 text-error focus:ring-red-500 cursor-pointer" 
                                ...
                                {!showExpiredOnly && (
                                    <select 
                                        className="w-full rounded-lg border border-base-300 bg-transparent h-7 px-2 text-[11px] font-bold text-base-content focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" 
                                        value={filterDays} 
            ...
            <div className="flex-1 overflow-auto">
              {loading ? (
                <div className="flex items-center justify-center h-64">
                  <span className="inline-block size-8 border-2 border-base-300 border-t-indigo-600 rounded-full animate-spin text-base-content/20"></span>
                </div>
              ) : lots.length === 0 ? (
                ...
                <table className="w-full text-xs border-separate border-spacing-0">
                  <thead className="bg-base-200 sticky top-0 z-30  border-b border-base-300">
                    <tr className="text-base-content/60 uppercase text-[10px] tracking-widest font-black">
                  ...
                  <tbody className="divide-y divide-base-300">
                    {lots.map((lot) => (
                      <tr key={lot.id} className={`hover:bg-base-200 transition-colors group ${lot.quantity_remaining <= 0 ? 'bg-base-100/50' : ''} ${selectedLotIds.has(lot.id) ? 'bg-primary/10' : ''}`}>
                        ...
                        <td className="py-2.5 px-4">
                            ...
                            <div className="text-[10px] font-mono text-base-content/50">#{lot.produit}</div>
                        </td>
                        <td className="py-2.5 px-4 text-center font-mono text-[11px] font-bold text-base-content/60">
                            {lot.lot || '-'}
                        </td>
                        <td className="py-2.5 px-4 text-center">
                          <div className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-base-200 text-base-content border border-base-300 font-black px-2 py-2 gap-1.5 ${lot.date_expiration && isExpired(lot.date_expiration) ? 'bg-error/10 text-error border-none' : 'bg-warning/10 text-warning border-none'}`}>
                            <Calendar className="size-3" />
                            {formatDate(lot.date_expiration || '')}
                          </div>
                        </td>
                        <td className="py-2.5 px-4 text-xs font-semibold text-base-content/60 truncate max-w-[140px]" title={lot.fournisseur_nom}>
                            {lot.fournisseur_nom}
                        </td>
                        <td className="py-2.5 px-4 text-right">
                            <div className={`font-black text-sm ${lot.quantity_remaining > 0 ? 'text-base-content' : 'text-base-content/40'}`}>
                        ...
                        <td className="py-2.5 px-4 text-center">
                          {lot.quantity_remaining > 0 ? (
                            <button 
                                className="inline-flex items-center gap-1 h-7 px-3 rounded-lg border border-red-200 bg-error/10 text-error text-xs font-bold hover:bg-error/20 transition-all opacity-0 group-hover: transition-all transform hover:scale-105"
                            ...
                            <span className="text-[10px] font-black text-base-content/40 uppercase tracking-widest flex items-center justify-center gap-1">
          ...
          <div className="space-y-4">
             {/* Filters */}
             <div className="mb-4 flex flex-wrap gap-4 items-center justify-between bg-base-200 p-4 rounded-xl border border-base-200">
                <div className="flex flex-wrap gap-4 items-center">
                    <div className="flex flex-col gap-1">
                        <span className="text-[10px] font-bold text-base-content/50 uppercase pl-1">{t('common:from')}</span>
                        <input 
                            type="date" 
                            className="w-full rounded-lg border border-base-300 bg-base-100 h-8 px-3 text-sm font-medium text-base-content focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" 
                            value={dateDebut}
                            onChange={(e) => setDateDebut(e.target.value)}
                        />
                    </div>
                    <div className="flex flex-col gap-1">
                        <span className="text-[10px] font-bold text-base-content/50 uppercase pl-1">{t('common:to')}</span>
                        <input 
                            type="date" 
                            className="w-full rounded-lg border border-base-300 bg-base-100 h-8 px-3 text-sm font-medium text-base-content focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" 
                            value={dateFin}
                ...
                <div className="flex items-center gap-2">
                    <button 
                        className="inline-flex items-center gap-2 px-3 py-1.5 border border-base-300 bg-base-100 text-base-content rounded-lg text-xs font-medium hover:bg-base-200 transition-colors"
                    ...
                    <button 
                        className="inline-flex items-center gap-2 px-3 py-1.5 bg-success text-white rounded-lg text-xs font-bold hover:bg-success-focus transition-colors shadow-sm"
             ...
             {adjustments.length > 0 && (
                  <div className="grid grid-cols-1 divide-y divide-base-200 shadow-sm border border-base-200 w-full mb-4 rounded-xl">
                    <div className="p-4">
                        <div className="text-xs font-bold uppercase text-base-content/60">{t('perimes.history.total_valorization')}</div>
                        <div className="text-error text-2xl font-bold">
                             {formatCurrency(adjustments.reduce((sum, a) => sum + (a.valorisation || 0), 0))}
                        </div>
                        <div className="text-sm font-medium text-base-content/50">{t('perimes.history.operations_count', { count: adjustments.length })}</div>
                    </div>
                  </div>
             )}
             ...
             {loadingAdjustments ? (
                ...
                <div className="flex flex-col items-center justify-center h-64 text-base-content/50 border-2 border-dashed border-base-200 rounded-2xl">
                ...
                <div className="bg-base-100 rounded-2xl shadow-sm border border-base-200 overflow-hidden">
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm border-separate border-spacing-0">
                            ...
                            <tbody>
                                {adjustments.map((adj) => (
                                    <tr key={adj.id} className="hover:bg-base-200 transition-colors">
