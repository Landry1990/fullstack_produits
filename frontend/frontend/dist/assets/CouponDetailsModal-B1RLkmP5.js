import{j as e}from"./vendor-query-C4s2QFJO.js";import{q as x}from"./feature-dashboard-Ce1cET6q.js";import{P as p,w as b,l as a}from"./feature-caisse-BxPlpoT-.js";import{u as f}from"./vendor-i18n-B5kTFDuS.js";import"./vendor-router-DJ94QBQg.js";import"./vendor-ui-4T-vgA-y.js";import"./vendor-dates-BrGixsn1.js";import"./vendor-http-Dqv9vB22.js";function _({isOpen:o,onClose:l,coupon:t,factureForCoupon:n,onAppliquer:d,settings:i}){const{t:s}=f("caisse"),m=()=>{if(!t)return;const r=window.open("about:blank","","height=600,width=400");if(r){const c=new Date(t.date_creation).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"});b(r,`<!DOCTYPE html>
<html>
<head>
