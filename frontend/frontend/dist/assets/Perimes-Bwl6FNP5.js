import{j as e}from"./vendor-query-Dscd91Be.js";import{u as pe,a}from"./vendor-i18n-DbEs1fka.js";import{q as we,r as Se,m as T,k as O,ad as $e,ae as Ce,af as G,B as k,j as R,D as w,H as C,o as u,E as le,F as ne,l as V,v as z,n as oe}from"./feature-dashboard-BM91DvTA.js";import{n as N,e as J,m as ze,aR as De,d as Te,l as Ee,aS as qe,Y as ce,X as Me,ae as Ie,s as Le,O as Ae,a8 as Pe,I as He}from"./vendor-ui-rEllUvbT.js";import{l as S,w as Oe,u as Re,T as K,g as Q,h as D,i as n,j as Z,k as o,C as ee,I as de,S as Ve}from"./feature-caisse-k9_Jfw1_.js";import{D as Fe,e as Be,f as Ue,g as We,h as Ye,i as Xe}from"./feature-ventes-D_VXxs50.js";import"./vendor-router-BUNIphaQ.js";import"./vendor-dates-BrGixsn1.js";import"./vendor-http-DhXgJQ-f.js";import"./feature-commandes-tcBpc6Kz.js";import"./feature-inventory-Bwto1oAp.js";import"./feature-inventory-editor-BQfRUkvh.js";import"./feature-history-Cj9rLWxI.js";import"./feature-inventory-states-ChpG9ALo.js";import"./vendor-xlsx-C2K9OxTh.js";import"./feature-reports-Bbk0OR_s.js";import"./vendor-pdf-BXAEnXi7.js";import"./feature-produits-DQ_o-vBN.js";import"./feature-settings-BDhj0OPv.js";function Ge(){const{settings:t}=we(),{t:c}=pe("common"),g=a.useRef(null),i=a.useCallback(()=>`
      * {
    ...
    `;h(M,x)},[i,_,f,h]),B=a.useCallback(d=>{window.open(d,"_blank")||N.error("Popup bloqué. Autorisez les popups pour imprimer.")},[]),U=a.useCallback((d,m)=>{const b=`
      <!DOCTYPE html>
      <html>
        <head>
          <style>${i()}</style>
