...
const replacements = [
  ...
  ['bg-base-200/50', 'bg-gray-50'],
  ['bg-base-200/30', 'bg-gray-50'],
  ['bg-base-200', 'bg-gray-100'],
  ['bg-base-50/50', 'bg-gray-50'],
  ['bg-base-50', 'bg-gray-50'],
  ['border-base-300/50', 'border-gray-200'],
  ['border-base-300', 'border-gray-200'],
  ['border-base-200', 'border-gray-100'],
  ['text-base-content/40', 'text-gray-400'],
  ['text-base-content/30', 'text-gray-400'],
  ['text-base-content/20', 'text-gray-300'],
  ['text-base-content/50', 'text-gray-500'],
  ['text-base-content/60', 'text-gray-500'],
  ['text-base-content/70', 'text-gray-500'],
  ['text-base-content/80', 'text-gray-500'],
  ['text-base-content', 'text-gray-900'],
  ['hover:bg-base-50', 'hover:bg-gray-50'],
  ['hover:bg-base-200/30', 'hover:bg-gray-50'],
  ['hover:bg-base-300', 'hover:bg-gray-200'],
  ['divide-base-100', 'divide-gray-100'],
  ['divide-base-200', 'divide-gray-200'],

  // Accent colors - primary
  ['bg-primary/5', 'bg-indigo-50'],
  ['bg-primary/10', 'bg-indigo-50'],
  ['bg-primary/20', 'bg-indigo-100'],
  ['text-primary-content', 'text-white'],
  ['text-primary', 'text-indigo-600'],
  ['bg-primary', 'bg-indigo-600'],
  ['border-primary/10', 'border-indigo-100'],
  ['border-primary/20', 'border-indigo-200'],
  ['border-primary/30', 'border-indigo-200'],
  ['border-primary', 'border-indigo-500'],

  // Accent colors - error
  ['bg-error/5', 'bg-red-50'],
  ['bg-error/10', 'bg-red-50'],
  ['bg-error/20', 'bg-red-100'],
  ['bg-error/30', 'bg-red-100'],
  ['text-error', 'text-red-600'],
  ['border-error/30', 'border-red-200'],
  ...
  // Tabs - use regex to avoid matching activeTab
...
console.log('Done refactoring Perimes.tsx');
