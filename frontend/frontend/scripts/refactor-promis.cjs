...
const files = [
  path.join(__dirname, '..', 'src', 'components', 'Promis.tsx'),
  path.join(__dirname, '..', 'src', 'components', 'promis', 'PromisFilters.tsx'),
  path.join(__dirname, '..', 'src', 'components', 'promis', 'PromisQuickStats.tsx'),
  path.join(__dirname, '..', 'src', 'components', 'promis', 'PromisTable.tsx'),
  path.join(__dirname, '..', 'src', 'components', 'promis', 'modals', 'PromisFormModal.tsx'),
  path.join(__dirname, '..', 'src', 'components', 'promis', 'modals', 'SmsModal.tsx'),
];
...
const replacements = [
  ...
  ['table table-zebra table-pin-rows w-full text-sm','w-full text-sm border-separate border-spacing-0'],
  ['table table-zebra table-sm','w-full text-sm border-separate border-spacing-0'],
  ['table table-zebra','w-full text-sm border-separate border-spacing-0'],
  ['table-zebra',''],
  ...
  ['input input-bordered w-full pl-9 focus:border-indigo-500 transition-colors','w-full rounded-lg border border-gray-200 bg-white pl-9 text-sm font-medium text-gray-900 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all'],
  ...
  ['input input-bordered w-full bg-base-200/50 font-mono text-base-content/80','w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm font-mono text-gray-500 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all'],
  ['input input-bordered w-full focus:border-indigo-500 transition-colors font-mono','w-full rounded-lg border border-gray-200 bg-white px-3 text-sm font-mono text-gray-900 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all'],
  ['input input-bordered w-full focus:border-indigo-500 transition-colors','w-full rounded-lg border border-gray-200 bg-white px-3 text-sm font-medium text-gray-900 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all'],
  ...
  ['select select-bordered bg-base-200/50 focus:bg-base-100 min-w-[140px]','w-full rounded-lg border border-gray-200 bg-gray-50 px-3 text-sm font-medium text-gray-900 focus:outline-none focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all min-w-[140px]'],
  ...
  // Textarea
  ['textarea textarea-bordered h-24 focus:border-indigo-500 transition-colors w-full','w-full rounded-lg border border-gray-200 bg-white p-3 text-sm font-medium text-gray-900 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all h-24'],
  ['textarea textarea-bordered h-32 focus:border-indigo-500 transition-colors text-base','w-full rounded-lg border border-gray-200 bg-white p-3 text-base font-medium text-gray-900 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-50 transition-all h-32'],
  // Buttons
  ...
  ['btn btn-info text-white shadow-sm hover:shadow-md transition-all gap-2 px-6','inline-flex items-center justify-center gap-2 h-9 px-6 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 hover:shadow-md transition-all shadow-sm'],
  ...
  ['dropdown dropdown-end dropdown-hover','relative inline-block'],
  ...
  ['dropdown-content z-[1] menu p-2 shadow-lg bg-base-100 rounded-xl w-44 border border-base-200','absolute z-50 mt-1 bg-white rounded-lg shadow-lg border border-gray-200 min-w-[11rem] py-1'],
